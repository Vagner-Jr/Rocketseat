...
<p align="center">
    Usando JavaScript motando um sidebar
</p>
...
## 💻 Projeto
  ...
  Projeto baseado em um site para uma clínica veterinária o qual foi feito um sidebar para busca e direcionamento a outras páginas. Você pode acessar o projeto online através [desse link](https://vagner-jr.github.io/Sidebar/).

## 🔖 Layout

Você pode visualizar o layout do projeto através [desse link](https://www.figma.com/file/58SDTZRvFVeHViYTkcH8GL/DD-%2F-Sidebar-Responsiva-(Copy)?node-id=0%3A1&t=sPyn2hPaIRtxwoZD-0). É necessário ter conta no [Figma](https://figma.com) para acessá-lo.
